 ...
 */
final class Version20191120134058 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE connection ADD CONSTRAINT FK_29F77366DA6F6929 FOREIGN KEY (database_fk_id) REFERENCES bdatabase (id)');
    }
